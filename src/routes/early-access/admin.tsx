    ...
    <main className="min-h-dvh bg-landing-canvas text-landing-ink">
      ...
      <div className="mx-auto max-w-[1200px] px-5 pb-24 pt-10 sm:px-8">
        ...
        >
          ...
          <p className="mt-2 text-xs text-landing-muted">
            Band-only buyers get the free app, and Apple emails them the TestFlight invite (with
            automatic invites set up; otherwise their order page shows the public link). With Base,
            the free days start when the buyer taps Start on their order page (the order email and
            the shipped email link to it). Without emails set up, send them the start link, only to
            their own address.
          </p>
        </Section>
