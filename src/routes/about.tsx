    ...
    <main className="min-h-dvh overflow-y-auto bg-background px-6 py-12">
      <div className="mx-auto flex max-w-md flex-col items-center text-center">
        ...
        <Section title="How it works">
          ...
          <p>
            <strong className="text-foreground">Notes.</strong> Double-tap the button and speak. The
            note is saved word for word, searchable in the app, with a title Band writes for you.
          </p>
          <p>
        ...
        <Section title="What the buzzes mean">
          <p>
            You never have to look at a screen to know where things stand. One short buzz means Band
            heard you. Two short buzzes means it accepted the task. Three short buzzes means it
            needs an answer from you. One long buzz means done. Two long buzzes means it couldn't
            finish.
          </p>
        </Section>
        ...
        <Section title="The hardware">
          <p>
            Band carries a heart rate sensor and motion sensing that run continuously in the
            background, a microphone for voice requests, a vibration motor for answers, and one
            physical button. The strap is woven, water resistant, and the battery lasts all day.
          </p>
        </Section>
        ...
        <div className="mt-10 text-2xl font-medium text-foreground">{bandPrice(data)}</div>
        <p className="mt-1 text-xs text-muted-foreground">Beta hardware · one time</p>
        <Link
          to="/checkout"
